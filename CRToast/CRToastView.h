...
#ifndef isIPhoneXr
#define isIPhoneXr (([[UIScreen mainScreen] nativeBounds].size.height) == 1792)
#endif
...
#define isNotchDevice (isIphoneX || isIPhoneXr || isIPhoneXsMax)
#endif

#ifndef naviBarHeightOffset
#define naviBarHeightOffset (isNotchDevice ? 24 : 0)
#endif
